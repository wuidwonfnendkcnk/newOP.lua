...
ray1.CFrame=dir*CFrame.Angles(math.rad(30),0,0)*CFrame.new(0,0,-(len/4))
ray1.Parent=char
ray2=ray1:clone()
ray2.Parent=char
ray2.CFrame=ray2.CFrame*CFrame.new(0,0,-(len/4))*CFrame.Angles(math.rad(-60),0,0)*CFrame.new(0,0,-(len/4))
end
