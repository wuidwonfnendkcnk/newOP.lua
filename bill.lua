...
socket.Size=Vector3.new(1.175,4,2.35)
...
part2=part1:clone()
part2.Parent=hat
part2.Size=part2.Size+Vector3.new(0,2.275,-0.75)
...
CLerp(part1,eye.CFrame*CFrame.new(0,7,0),1)
CLerp(part2,part1.CFrame*CFrame.new(0,1.25,0),1.25)
end)
