...
WELD22.C0=L(WELD22.C0,POS*CFrame.Angles(math.sin(Sine/3)*0.28,0,0),0.2) -- CFRAMETOLERP:Lerp(POS,SPEED)
WELD2.C0= L(WELD2.C0,POS2*CFrame.Angles(math.sin(Sine/3)*0.26,0,0),0.06) -- CFRAMETOLERP:Lerp(POS,SPEED)
